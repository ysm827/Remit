...
_LEVEL_STYLE: dict[str, dict[str, str]] = {
    "success": {"emoji": "◆", "color": "bright_green", "prefix": "完成"},
    "error": {"emoji": "×", "color": "bright_red", "prefix": "失败"},
    "warning": {"emoji": "△", "color": "gold1", "prefix": "注意"},
    "info": {"emoji": "•", "color": "bright_cyan", "prefix": "进展"},
    "debug": {"emoji": "·", "color": "grey62", "prefix": "诊断"},
}
